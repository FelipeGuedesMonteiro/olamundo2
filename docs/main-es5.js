...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-app>\n    <ion-split-pane contentId=\"main-content\">\n        <ion-menu contentId=\"main-content\" type=\"overlay\">\n            <ion-content>\n\n                <ion-list id=\"inbox-list\">\n                    <ion-list-header class=\"ion-margin-bottom\">Menu</ion-list-header>\n                    <!-- <ion-note>O melhor App do mundo</ion-note> -->\n\n                    <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages; let i = index\">\n                        <ion-item (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                            <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                            <ion-label>{{ p.title }}</ion-label>\n                        </ion-item>\n                    </ion-menu-toggle>\n                </ion-list>\n\n            </ion-content>\n        </ion-menu>\n\n        <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n\n    </ion-split-pane>\n</ion-app>";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }, // Rota criada automaticamente ao criar as páginas
    {
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/pages/e404/e404.module.ts")).then(function (m) {
    ...
    }, // Rota para listagem de usuários
    {
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | users-listusers-listusers-module */
        "users-listusers-listusers-module").then(__webpack_require__.bind(null,
        /*! ./users/listusers/listusers.module */
        "./src/app/users/listusers/listusers.module.ts")).then(function (m) {
          return m.ListusersPageModule;
        });
      }
    }, // Rota para exibir detalhes do usuário
    {
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | users-user-user-module */
        "users-user-user-module").then(__webpack_require__.bind(null,
        /*! ./users/user/user.module */
        "./src/app/users/user/user.module.ts")).then(function (m) {
    ...
    }, // Rota para cadastrar usuário
    {
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | users-create-create-module */
        "default~users-create-create-module~users-edit-edit-module").then(__webpack_require__.bind(null,
        /*! ./users/create/create.module */
        "./src/app/users/create/create.module.ts")).then(function (m) {
    ...
    }, // Rota para editar um registro existente
    {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | users-edit-edit-module */
        [__webpack_require__.e("default~users-create-create-module~users-edit-edit-module"), __webpack_require__.e("users-edit-edit-module")]).then(__webpack_require__.bind(null,
        /*! ./users/edit/edit.module */
        "./src/app/users/edit/edit.module.ts")).then(function (m) {
    ...
    }, // Rota para status do dispositivo
    {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | device-status-status-module */
        [__webpack_require__.e("default~device-camera-camera-module~device-geolocation-geolocation-module~device-status-status-modul~f5a33472"), __webpack_require__.e("device-status-status-module")]).then(__webpack_require__.bind(null,
        /*! ./device/status/status.module */
        "./src/app/device/status/status.module.ts")).then(function (m) {
    ...
    }, // Rota para tirar foto
    {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | device-camera-camera-module */
        [__webpack_require__.e("default~device-camera-camera-module~device-geolocation-geolocation-module~device-status-status-modul~f5a33472"), __webpack_require__.e("device-camera-camera-module")]).then(__webpack_require__.bind(null,
        /*! ./device/camera/camera.module */
        "./src/app/device/camera/camera.module.ts")).then(function (m) {
    ...
    }, // Rota do GPS
    {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | device-geolocation-geolocation-module */
        [__webpack_require__.e("default~device-camera-camera-module~device-geolocation-geolocation-module~device-status-status-modul~f5a33472"), __webpack_require__.e("device-geolocation-geolocation-module")]).then(__webpack_require__.bind(null,
        /*! ./device/geolocation/geolocation.module */
        "./src/app/device/geolocation/geolocation.module.ts")).then(function (m) {
    ...
    }, ///// Galeria de Fotos
    {
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~device-camera-camera-module~device-geolocation-geolocation-module~device-status-status-modul~f5a33472"), __webpack_require__.e("gallery-gallery-module")]).then(__webpack_require__.bind(null,
  ...
  function srcAppAppComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-menu ion-content {\n  --background: var(--ion-item-background, var(--ion-background-color, #fff));\n}\n\nion-menu.md ion-content {\n  --padding-start: 8px;\n  --padding-end: 8px;\n  --padding-top: 20px;\n  --padding-bottom: 20px;\n}\n\nion-menu.md ion-list {\n  padding: 20px 0;\n}\n\nion-menu.md ion-note {\n  margin-bottom: 30px;\n}\n\nion-menu.md ion-list-header,\nion-menu.md ion-note {\n  padding-left: 10px;\n}\n\nion-menu.md ion-list#inbox-list {\n  border-bottom: 1px solid var(--ion-color-step-150, #d7d8da);\n}\n\nion-menu.md ion-list#inbox-list ion-list-header {\n  font-size: 22px;\n  font-weight: 600;\n  min-height: 20px;\n}\n\nion-menu.md ion-list#labels-list ion-list-header {\n  font-size: 16px;\n  margin-bottom: 18px;\n  color: #757575;\n  min-height: 26px;\n}\n\nion-menu.md ion-item {\n  --padding-start: 10px;\n  --padding-end: 10px;\n  border-radius: 4px;\n}\n\nion-menu.md ion-item.selected {\n  --background: rgba(var(--ion-color-primary-rgb), 0.14);\n}\n\nion-menu.md ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\nion-menu.md ion-item ion-icon {\n  color: #616e7e;\n}\n\nion-menu.md ion-item ion-label {\n  font-weight: 500;\n}\n\nion-menu.ios ion-content {\n  --padding-bottom: 20px;\n}\n\nion-menu.ios ion-list {\n  padding: 20px 0 0 0;\n}\n\nion-menu.ios ion-note {\n  line-height: 24px;\n  margin-bottom: 20px;\n}\n\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --padding-end: 16px;\n  --min-height: 50px;\n}\n\nion-menu.ios ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\nion-menu.ios ion-item ion-icon {\n  font-size: 24px;\n  color: #73849a;\n}\n\nion-menu.ios ion-list#labels-list ion-list-header {\n  margin-bottom: 8px;\n}\n\nion-menu.ios ion-list-header,\nion-menu.ios ion-note {\n  padding-left: 16px;\n  padding-right: 16px;\n}\n\nion-menu.ios ion-note {\n  margin-bottom: 8px;\n}\n\nion-note {\n  display: inline-block;\n  font-size: 16px;\n  color: var(--ion-color-medium-shade);\n}\n\nion-item.selected {\n  --color: var(--ion-color-primary);\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(platform, splashScreen, statusBar) {
        ...
        this.appPages = [// Item de menu "home"
        {
          title: 'Início',
          url: '/home',
          icon: 'home'
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/fesm2015/http.js"); // Importa o serviço de acesso aos usuários da API
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], // Inicialização da classe HttpClientModule
  ...
  function srcAppServicesUsersServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/fesm2015/http.js"); // Importa módulo HTTP do Angular
    ...
    var UsersService = /*#__PURE__*/function () {
      ...
      function UsersService(http) {
        ...
        this.http = http; // URL da API
        // private apiurl = 'http://localhost:8888/api';

        this.apiurl = 'http://192.168.1.6:8888/api';
      ...
      _createClass(UsersService, [{
        ...
        value: function getUser(id) {
          // Inclui o Id na URL
          var url = "".concat(this.apiurl, "?id=").concat(id); // Faz o GET na API
        ...
        value: function deleteUser(id) {
          // Inclui o Id na URL
          var url = "".concat(this.apiurl, "?id=").concat(id); // Faz o DELETE na API
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Projetos Ionic\olamundo2\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
