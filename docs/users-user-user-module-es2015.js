...
/* harmony import */ var _user_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user.page */ "./src/app/users/user/user.page.ts");
...
/* harmony import */ var _user_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./user-routing.module */ "./src/app/users/user/user-routing.module.ts");
/* harmony import */ var _user_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user.page */ "./src/app/users/user/user.page.ts");
...
let UserPage = class UserPage {
    ...
    ngOnInit() {
        ...
        this.usersService.getUser(this.id.toString()).subscribe((res) => {
...
Clique em [Ok] para apagar e [Cancelar] para não apagar...`)) {
        ...
        this.usersService.deleteUser(this.id.toString()).subscribe((res) => {
            // Se apagou
...
UserPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-user',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/users/user/user.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user.page.scss */ "./src/app/users/user/user.page.scss")).default]
    }),
...
//# sourceMappingURL=users-user-user-module-es2015.js.map